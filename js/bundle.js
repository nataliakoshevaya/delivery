...
/* harmony export */   "default": () => __WEBPACK_DEFAULT_EXPORT__
/* harmony export */ });
/* harmony import */ var _serveses__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./serveses */ "./js/modules/serveses.js");
...
function cards() {
    ...
    (0,_serveses__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu')
        .then(data => {
...
/* harmony import */ var _serveses__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./serveses */ "./js/modules/serveses.js");
      ...
      function bindPostData(form) {
          form.addEventListener('submit', (event) => {
           ...
           `;
              ...
              (0,_serveses__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json)
                  .then(data => {
                      console.log(data);
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2020-12-29');
